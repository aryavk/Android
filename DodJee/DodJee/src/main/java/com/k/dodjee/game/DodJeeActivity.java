...
public class DodJeeActivity extends ActionBarActivity implements GameListener
{
    ...
    public void onLose(final int score)
    {
        ...
        runOnUiThread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                GameOverDialog dialog = new GameOverDialog(DodJeeActivity.this, gameResources, GameState.LOSS, score);
                dialog.buildDialog();
                dialog.show();
            }
        });
    ...
    public void onWin(final int newLevel, final int score)
    {
        runOnUiThread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                {
                    panel = new DodJeeGame(DodJeeActivity.this);
                    panel.setupResources(score, newLevel, gameResources);
                    setContentView(panel.getGamePanelView());
                } else
                {
                    saveScore(score, false);
                    GameOverDialog dialog = new GameOverDialog(DodJeeActivity.this, gameResources, GameState.WIN, score);
                    dialog.buildDialog();
                    dialog.show();
                }
            }
    ...
    public void onResume()
    {
        ...
        {
            panel = new DodJeeGame(this, panel.getGamePanelResources());
            setContentView(panel.getGamePanelView());
        }
    }
    ...
    public static class PlaceholderFragment extends Fragment
    {
        ...
        public void onActivityCreated(Bundle savedInstanceState)
        {
            ...
            ((DodJeeActivity)getActivity()).showScore();
            ((DodJeeActivity)getActivity()).showAvatars();
        }
    }
